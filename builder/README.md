...
- uses: bcgov/actions/builder@vX.Y.Z
  with:
    ...
    # Defaults to pull request number in pull_request workflows
    # Required for non-PR events (push, workflow_dispatch, schedule)
...
| `annotations` | Generated OCI annotations                   |
