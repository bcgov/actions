...
assert_python_version "" "" "$TMP_DIR/pv-pep" "$TMP_DIR/pv-pep" "3.10|" "auto-discover: requires-python from pyproject.toml"
...
assert_java_version "" "" "$TMP_DIR/jv-sdkman" "$TMP_DIR/jv-sdkman" "21|" "auto-discover: .sdkmanrc java="
